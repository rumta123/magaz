...
let FileUploadController = class FileUploadController {
    ...
    async uploadMultiple(files) {
        if (!files || files.length === 0) {
            throw new common_1.BadRequestException("Файлы не найдены");
        }
        const urls = await this.fileUploadService.uploadMultipleFiles(files, "products");
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], FileUploadController.prototype, "uploadCategoryImage", null);
